    ...
    <div className="min-h-screen bg-background p-6">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-card border border-border rounded-xl p-6 mb-6">
          ...
          {isChecking && !healthStatus ? (
            ...
            <div className="space-y-4">
              ...
              {/* Overall Status */}
              <div className={`p-4 rounded-lg ${healthStatus.overall ? 'bg-green-50 border border-green-200' : 'bg-red-50 border border-red-200'}`}>
                <p className={`font-medium ${healthStatus.overall ? 'text-green-700' : 'text-red-700'}`}>
        ...
        <div className="bg-card border border-border rounded-xl p-6 mb-6">
          ...
          {feedbackTestResult && (
            <div className={`p-4 rounded-lg ${feedbackTestResult.success ? 'bg-green-50 border border-green-200' : 'bg-red-50 border border-red-200'}`}>
              <div className="flex items-center gap-2">
                <StatusIcon ok={feedbackTestResult.success} />
                <p className={`font-medium ${feedbackTestResult.success ? 'text-green-700' : 'text-red-700'}`}>
        ...
        <div className="bg-card border border-border rounded-xl p-6 mb-6">
          ...
          {aiTestResult && (
            <div className={`p-4 rounded-lg ${aiTestResult.success ? 'bg-green-50 border border-green-200' : 'bg-red-50 border border-red-200'}`}>
              <div className="flex items-center gap-2">
                <StatusIcon ok={aiTestResult.success} />
                <p className={`font-medium ${aiTestResult.success ? 'text-green-700' : 'text-red-700'}`}>
